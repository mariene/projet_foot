...
team2.add_player(SoccerPlayer("t2j2",Degage()))
...
team5.add_player(SoccerPlayer("DeG",MixSimple()))
#team5.add_player(SoccerPlayer("DefenG",Defenseur()))
#team5.add_player(SoccerPlayer("Def",Def()))
team5.add_player(SoccerPlayer("comp",comp))
