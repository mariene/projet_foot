...
from outils import AllerVers, AllerVersBalle,AllerVersBalleBis,Tirer,TirerVersBut

team1=SoccerTeam("team1")
team2=SoccerTeam("team2")
team1.add_player(SoccerPlayer("t1j1",AllerVersBalle()))
team2.add_player(SoccerPlayer("t2j1", AllerVers()))
team1.add_player(SoccerPlayer("t1j2",TirerVersBut()))
team2.add_player(SoccerPlayer("t2j2",Tirer()))
